<?php
		...
		$command = escapeshellcmd('./train.py');
...
<html>
	...
	<meta http-equiv="refresh" content="5;url=epoch.php" />
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-4 gtco-footer-subscribe">
						<?php
								...
								$con=mysqli_connect("localhost","root","","pythondb");
								$a=$_POST['epoch'];
								$query="UPDATE epoch SET epoch = $a WHERE id=1;";
								if(mysqli_query($con,$query))
								echo("<center>");
								echo ("Epoch Count input successful");
								echo("</center>");									
